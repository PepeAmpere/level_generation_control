...
local ROTATION_LEFT = HexBase.ROTATION_LEFT
local ROTATION_RIGHT = HexBase.ROTATION_RIGHT


local HexTurtle = {}
HexTurtle.__index = HexTurtle

function HexTurtle.new(position, direction, stepSize, formula, customMethods)
  ...
  i.branchPoints = {} -- key => {position = Hex3, direction = <dir>, parentID = nodeID}
